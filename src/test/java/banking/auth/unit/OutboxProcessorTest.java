...
import banking.auth.service.processor.OutboxTxService;
...
public class OutboxProcessorTest {
    ...
    private static OutboxEvent createEvent(UUID id, String aggregateType, UUID aggregateId, String topic,
                                           ObjectNode payload) {
